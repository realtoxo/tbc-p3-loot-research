...
- ranged: Libram of Avengement replaces nothing. THE PHASE 3 PAGE RANKS NOTHING IN THIS SLOT. Ruled by the guild lead, 15 August 2026: carry the entry capture's pick forward. So one slot of this otherwise Phase 3 set is sourced from a PHASE 2 page, data/facts/sim-profiles/hit-capture/retribution-paladin.yaml.
