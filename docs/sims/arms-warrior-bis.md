...
| Figure                     | Value                                                                                 |
|----------------------------|---------------------------------------------------------------------------------------|
| Damage per second          | **2426.4**                                                                            |
| Standard error on the mean | ± 1.36                                                                                |
| Spread across iterations   | 136.4                                                                                 |
...
## 3 slots the published list does not rank this way
...
|-----------|--------------------|---------------------------|
| Main hand | `Cataclysm's Edge` | `Warglaive of Azzinoth`   |
| Off hand  | `EMPTY`            | `Warglaive of Azzinoth`   |
| Trinket 2 | `Bloodlust Brooch` | `Badge of the Swarmguard` |
